...
export class SongService {
  ...
  private readonly getLyricsUseCase: GetLyricsUseCase
  ...
  constructor() {
    ...
    this.getLyricsUseCase = new GetLyricsUseCase()
  }
  ...
  getLyrics = (args: GetLyricsArgs) => {
    return this.getLyricsUseCase.execute(args)
  }
}
